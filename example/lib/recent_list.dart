...
const List<MediaUrl> samples = [
  ...
  MediaUrl(title: "竖屏", url: "https://cdn.wlcdn88.com:777/dfc69d3a/index.m3u8"),
...
class RecentMediaList extends StatefulWidget {
  ...
  @override
  State<RecentMediaList> createState() => _RecentMediaListState();
}
...
class _RecentMediaListState extends State<RecentMediaList> {
  ...
  Future<void> asyncSetup() async {
    ...
    _counterSubscription = counter.listen(onHistoryChanged);
  }

  void onHistoryChanged(int v) {
    if (!mounted) return;
